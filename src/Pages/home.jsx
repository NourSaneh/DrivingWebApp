...
const [progress, setProgress] = useState(0);
  ...
  const handleCardClick = (title) => {
    ...
    // if (title === "Traffic Signs") onNavigate("trafficsigns");
    // if (title === "Traffic Questions") onNavigate("trafficquestions");
    // if (title === "Test Simulator") onNavigate("testsimulator");
    // if (title === "Car Parts") onNavigate("carparts");
  };
  ...
  const features = [
    {
      ...
      title: "Traffic Signs",
      description:
        "Learn all mandatory, warning, and information signs used on Lebanese roads.",
    ...
    },
    {
      ...
      description:
        "Practice with official exam questions and test your knowledge of traffic rules.",
    ...
    },
    {
      ...
      description:
        "Simulate the actual exam experience with our realistic test simulator.",
    ...
    },
    {
      ...
      title: "Car Parts",
      description:
        "Learn about essential car components and their functions for your exam.",
